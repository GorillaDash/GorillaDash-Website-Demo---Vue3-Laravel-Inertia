...
// static/clients/juniperTable_/ and are served via the CDN below.
...
export const STATIC_SOURCES_URL =
  import.meta.env.VITE_GCS_STATIC_URL ?? 'https://cdn.gorilladash.com/static/clients/juniperTable_'
