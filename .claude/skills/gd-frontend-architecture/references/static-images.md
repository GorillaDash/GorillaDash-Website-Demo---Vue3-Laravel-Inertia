...
public/static/images/bg/hero-bg.jpg
  → gs://gorilladash-static-files/static/clients/hungryGorilla_/images/bg/hero-bg.jpg
  → served at https://cdn.gorilladash.com/static/clients/hungryGorilla_/images/bg/hero-bg.jpg
```
...
// menuPath → https://cdn.gorilladash.com/static/clients/hungryGorilla_/images/menu
```
